...
Route::get('reset_password')->name('auth.forgot_password')->uses('Auth\ForgotPasswordController@forgotPasswordPage');
Route::post('reset_password')->name('auth.request_password')->uses('Auth\ForgotPasswordController@requestNewPassword');
